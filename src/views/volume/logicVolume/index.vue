<template>
  <div style="height: 881px" @contextmenu.prevent>
    <el-container style="height: 100%;">
      <el-row :gutter="30" style="width: 100%;">
        <!-- 侧边栏 -->
        <el-col :xs="24" :sm="6" :md="5" :lg="5" :xl="5">
          <el-aside style="height: 100%; overflow-y: auto; padding-right: 10px;">
      ...
      <el-card class="drawer-card">
        ...
        <div class="drawer-content">
              ...
              <el-col :span="12">
                <el-radio v-model="volumeType" label="PhysicalVolume" border class="type-card">
                  <div class="type-content">
                    <i class="el-icon-folder" />
                    <span>物理卷</span>
                    <p class="type-description">直接映射到物理存储设备</p>
                  </div>
                </el-radio>
              </el-col>
              <el-col :span="12">
              ...
              <el-col :span="12">
                <el-radio v-model="volumeType" label="SpannedVolume" border class="type-card">
                  <div class="type-content">
                    ...
                    <span>跨区卷</span>
                    <p class="type-description">跨多个物理卷扩展容量</p>
                  </div>
                </el-radio>
              </el-col>
              <el-col :span="12">
                <el-radio v-model="volumeType" label="StripVolume" border class="type-card">
                  <div class="type-content">
                    ...
                    <span>条带卷</span>
                    <p class="type-description">数据分布到多个物理卷，提升性能</p>
                  </div>
                </el-radio>
              </el-col>
            </el-row>
          ...
          <el-form label-width="100px">
            ...
            <el-form-item v-if="volumeType === 'PhysicalVolume'" label="挂载点">
    ...
    >
      <el-card class="drawer-card">
        ...
        <div class="drawer-content">
          ...
          <el-divider />
          <el-select v-model="selectExpansionVolume" placeholder="请选择卷" class="expansion-select">
            <el-option
  ...
  methods: {
    ...
    submitExpand() {
      ...
      const requestData = {
        ...
        childGuid: this.selectExpansionVolume
      }
