...
export const constantRoutes = [
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        //   {
        //     path: 'logic',
        //     component: () => import('@/views/volume/logicVolume/index.vue'),
        //     name: 'logicVolumeManagement',
        //     meta: { title: 'logicVolume' }
        //   }
        // ]
      },
      {
  ...
  },
  {
    path: '/bucketSpace',
    component: Layout,
    redirect: '/bucketSpace/bucketSpace',
    hidden: true,
    name: 'bucketSpace',
    meta: {
      title: 'bucketSpace',
    ...
    children: [
      {
        path: 'bucketSpace',
        component: () => import('@/views/bucketSpace/index'),
        name: 'bucket空间',
        meta: { title: 'bucketSpace' },
        children: [
          {
            path: 'fileList',
            component: () => import('@/views/bucketSpace/children/fileList'),
            name: 'fileList',
            meta: { title: 'fileList' }
          }
        ]
